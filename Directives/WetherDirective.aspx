<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WetherDirective.aspx.cs" Inherits="Directives.WetherDirective" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Wether Directive (ng-sparline)</title>
    <script src="Scripts/angular.js"></script>
        <script src="http://www.ng-newsletter.com/js/vendor/d3.v3.min.js"></script>


</head>
<body data-ng-app="wetherDirective">
    
    <input type="text"  placeholder="Enter a city" />
    <div ng-sparkline data-ng-city="San Fransisco" width='400' >
    ...
    <script type="text/javascript">
        ...
        var app = angular.module('wetherDirective', []);
